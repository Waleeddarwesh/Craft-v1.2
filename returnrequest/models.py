...
class ReturnRequestManager(models.Manager):
    def for_user(self, user):
        ...
        if hasattr(user, 'delivery'):
            return self.filter(delivery_person=user.delivery)
...
class ReturnRequest(models.Model):
    ...
    delivery_person = models.ForeignKey('accounts.Delivery', on_delete=models.CASCADE, null=True, blank=True, related_name='assigned_returns')
